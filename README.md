...
<p align="center">
  <img src="https://img.shields.io/badge/B.Tech-Computer%20Science%20Engineering-7C3AED?style=flat-square&logo=academia&logoColor=white" />
  <img src="https://img.shields.io/badge/CGPA-7.8%20%2F%2010-6D28D9?style=flat-square&logo=checkmarx&logoColor=white" />
  <img src="https://img.shields.io/badge/Experience-2%2B%20Years-8B5CF6?style=flat-square&logo=buffer&logoColor=white" />
  <img src="https://img.shields.io/badge/Projects-50%2B%20Delivered-5B21B6?style=flat-square&logo=gitbook&logoColor=white" />
</p>
...
<p align="center">
  <a href="https://www.abhaymallick.space/">
    <a href="https://www.abhaydev.space/">
...
My **mobile engineering** practice leverages Kotlin and Jetpack Compose to deliver declarative, performant native Android applications with real-time data capabilities. On the **DevOps and infrastructure** front, I operate within Docker-containerized, AWS-deployed, CI/CD-automated environments to ship production-grade applications at scale.

I have **delivered 50+ production-ready projects** spanning bespoke enterprise CRMs, lifestyle platforms, smart city governance portals, AI-native developer tools, and interactive education systems for clients across India, the US, and Australia.

```
🔭  Currently Building    →  Cosmic IDE  |  abhaymallick.space
🌱  Currently Mastering   →  Distributed Cloud  |  Microservices  |  System Design
🤝  Open To               →  Freelance Contracts  |  Full-Time Roles  |  Open Source Collaboration
📬  Reach Me              →  abhaymallick.dev@gmail.com
```
...
<p align="center">
  ...
  <br/>
  <img src="https://img.shields.io/badge/CI%2FCD%20Pipelines-1E1B4B?style=flat-square&logo=githubactions&logoColor=A78BFA" />
  <img src="https://img.shields.io/badge/Electron.js-47848F?style=flat-square&logo=electron&logoColor=white" />
  <img src="https://img.shields.io/badge/Agile%20%2F%20Scrum-7C3AED?style=flat-square&logo=jira&logoColor=white" />
</p>
...
|--------|-------------|---------|
| **LLM Integration** | ⬛⬛⬛⬛⬜ Advanced | Gemini API, Netmind API, prompt engineering, agentic workflows |
| **Computer Vision** | ⬛⬛⬛⬜⬜ Proficient | Disease detection, species identification, image classification |
| **Predictive Analytics** | ⬛⬛⬛⬛⬜ Advanced | ML-based dashboards, house price prediction, trend modeling |
| **NLP & Task Automation** | ⬛⬛⬛⬜⬜ Proficient | Natural language schedulers, intent parsing, AI task orchestration |
| **AI-Native Tooling** | ⬛⬛⬛⬛⬜ Advanced | Autonomous coding agents, terminal loops, multi-language debuggers |
| **ML Infrastructure** | ⬛⬛⬛⬜⬜ Proficient | Python ML pipelines, REST-exposed model endpoints, cloud inference |
...
| Attribute | Details |
|-----------|---------|
| **Stack** | React, Node.js, Electron.js, Gemini API, TypeScript |
| **Scale** | Desktop application — cross-platform (Windows / macOS / Linux) |
| **Performance** | Asynchronous agent execution, non-blocking terminal loops, lazy-loaded extension registry |
| **Security** | Sandboxed agent execution, permission-gated file system access |
| **Impact** | Professional developer tooling — AI coding agent + IDE in a single unified desktop environment |
| **Repository** | [github.com/Abhay2204/Cosmic-IDE](https://github.com/Abhay2204/Cosmic-IDE) |
...
| Attribute | Details |
|-----------|---------|
| **Stack** | React, Node.js, PostgreSQL, Electron.js, REST APIs |
| **Scale** | Enterprise-grade — multi-user concurrent access, relational data modeling |
| **Performance** | Optimized SQL queries, indexed relational schemas, paginated data views |
| **Security** | Role-based access control, JWT authentication, encrypted credential storage |
| **Impact** | Streamlined enrollment operations, reduced lead response latency, centralized workflow visibility |
...
| Attribute | Details |
|-----------|---------|
| **Stack** | Kotlin, Jetpack Compose, Firebase, Netmind API, Android SDK |
| **Scale** | Native Android — real-time inference, multi-feature ecosystem |
| **Performance** | Declarative UI composition, asynchronous image processing, optimized Firebase queries |
| **Security** | Firebase Authentication, Firestore security rules, API key sandboxing |
| **Impact** | End-to-end pet care platform — disease detection, rescue connectivity, intelligent recommendations |
| **Repository** | [github.com/Abhay2204](https://github.com/Abhay2204) |
...
| **Impact** | End-to-end ML product — from raw data to interactive price prediction UI |
| **Repository** | [github.com/Abhay2204](https://github.com/Abhay2204) |
...
| Attribute | Details |
|-----------|---------|
| **Stack** | React Native, Vue.js, REST APIs |
| **Scale** | Cross-platform — mobile-first with web companion |
| **Performance** | Optimized animation rendering, lazy-loaded algorithm modules, offline content caching |
| **Security** | Authenticated user sessions, sandboxed code execution environment |
| **Impact** | Structured DSA learning ecosystem with visual + hands-on practice modules |
| **Repository** | [github.com/Abhay2204](https://github.com/Abhay2204) |
...
- Delivered a worker management system supporting multi-department personnel operations
- Participated in system design reviews and contributed to architecture decisions for internal platforms

`Java` `Spring Boot` `React` `SQL` `REST APIs` `PostgreSQL`
...
<p align="center">
  <img src="https://img.shields.io/badge/Web%20Development%20Certification-Satgurur%20Institute%20%7C%202023-6D28D9?style=for-the-badge&logo=html5&logoColor=white" />
</p>
<p align="center">
  <img src="https://img.shields.io/badge/50%2B%20Projects%20Delivered-Web%20%7C%20Mobile%20%7C%20Enterprise%20%7C%20AI-5B21B6?style=for-the-badge&logo=checkmarx&logoColor=white" />
</p>
...
```yaml
learning:
  - Distributed cloud architecture (AWS ECS, RDS, CloudFront)
  - Microservices design patterns and event-driven systems
  - High-load system design and database optimization at scale

building:
  - Cosmic IDE — autonomous agent-powered desktop IDE (React + Node.js + Electron)
  - abhaymallick.space — hyper-optimized portfolio targeting 100/100 Lighthouse score

exploring:
  - LLM orchestration frameworks (LangChain, LlamaIndex)
  - Edge deployment and serverless architectures
  - GraphQL federation and API gateway patterns

open_to:
  - Full-time Software Engineering roles (Remote / Hybrid)
  - Freelance contracts — Web, Mobile, AI, Enterprise Software
  - Open source collaboration on developer tooling and AI applications
  - Technical co-founding opportunities in early-stage startups
```
...
<p align="center">
  <em>Engineering is not the art of building devices; it is the art of fixing mistakes.</em>
</p>
